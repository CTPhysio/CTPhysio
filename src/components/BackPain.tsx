...
const BackPain: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <Seo
        title="Lower Back Pain Physiotherapy in Harborne | Chris Tiley Physiotherapy"
        description="Physiotherapy for lower back pain in Harborne, helping you understand your symptoms, improve movement and build confidence in managing your back pain."
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/treatments/sciatica" className="px-5 py-2.5 bg-gray-100 text-navy-700 font-semibold rounded-lg hover:bg-navy-700 hover:text-white transition-colors">Sciatica</a>
      ...
      <TreatmentCTA conditionName="back pain" />
    </div>
  );
};
