...
const Deconditioning: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <Seo
        title="Physiotherapy for Muscle Weakness & Deconditioning | Chris Tiley Physiotherapy"
        description="Physiotherapy and progressive exercise for muscle weakness and deconditioning in Harborne, helping you rebuild strength, fitness and confidence."
      ...
      <TreatmentCTA conditionName="deconditioning and muscle weakness" />
    </div>
  );
};
