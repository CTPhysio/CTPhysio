          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 md:order-2 space-y-6 md:space-y-8">
              ...
              <div className="pt-6">
                <a
                  href="/services"
                  className="inline-flex items-center px-6 py-3 md:px-8 md:py-4 bg-navy-700 text-white font-bold rounded-lg hover:bg-navy-800 transition-colors text-sm md:text-base"
                >
                  Learn More
                </a>
              </div>
