...
const NeckPain: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <Seo
        title="Neck Pain Physiotherapy in Harborne | Chris Tiley Physiotherapy"
        description="Physiotherapy for neck pain and stiffness in Harborne, helping you improve movement, reduce discomfort and build confidence in everyday activities."
      ...
      <TreatmentCTA conditionName="neck pain" />
    </div>
  );
};
