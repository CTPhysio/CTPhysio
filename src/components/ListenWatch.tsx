...
const resources = [
  {
    ...
    description: 'Practical videos and advice from Chris Tiley, physiotherapist and founder of Chris Tiley Physiotherapy, to help you build strength, move well and stay active as you get older.',
