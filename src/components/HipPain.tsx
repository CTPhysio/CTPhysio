...
const HipPain: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <Seo
        title="Hip Pain Physiotherapy in Harborne | Chris Tiley Physiotherapy"
        description="Physiotherapy for hip pain and stiffness in Harborne, helping you improve mobility, strength and confidence with everyday activities."
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/treatments/back-pain" className="px-5 py-2.5 bg-gray-100 text-navy-700 font-semibold rounded-lg hover:bg-navy-700 hover:text-white transition-colors">Back Pain</a>
            ...
            <a href="/treatments/balance-falls" className="px-5 py-2.5 bg-gray-100 text-navy-700 font-semibold rounded-lg hover:bg-navy-700 hover:text-white transition-colors">Balance & Falls</a>
          </div>
        </div>
      </section>

      <TreatmentCTA conditionName="hip pain" />
    </div>
  );
};
